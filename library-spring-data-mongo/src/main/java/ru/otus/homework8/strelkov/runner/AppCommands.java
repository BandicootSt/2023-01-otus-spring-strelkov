package ru.otus.homework8.strelkov.runner;
...
public class AppCommands {
    ...
    public String addBook(
        ...
        @ShellOption("a_id") String authorId,
        @ShellOption("g_id") String genreId
    ) {
    ...
    public String getAuthorById(@ShellOption("id") String authorId) {
    ...
    public String getGenreById(@ShellOption("id") String genreId) {
    ...
    public String getCommentsByBookId(@ShellOption("bookId") String bookId) {
    ...
    public String getCommentById(@ShellOption("id") String commentId) {
    ...
    public String updateComment(
        ...
        @ShellOption("id") String commentId
    ) {
