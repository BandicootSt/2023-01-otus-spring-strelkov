...
insert into book_comments(text, book_id) values('TestComment1', 1);
insert into book_comments(text, book_id) values('TestComment2', 1);
insert into book_comments(text, book_id) values('TestComment3', 1);